        ...
        168: function (e, t, n) {
            ...
            !function () {
                ...
                !function () {
                    var u,
                    s,
                    f = window.performance || window.webkitPerformance || window.msPerformance || window.mozPerformance,
                    d = "data-cf-beacon",
                        ...
                        if (f && m && m.token) {
                            ...
                            document.addEventListener("visibilitychange", (function () {
                                    if ("hidden" === document.visibilityState) {
                                        if (L && A()) {
                                            var t = e();
                                            (null == S ? void 0 : S.url) == t && (null == S ? void 0 : S.triggered) || P(),
                                            O(t)
                                        }
                                        !E && S && (E = !0, R())
                                    } else
                            ...
                            C = m.send && m.send.to ? m.send.to : void 0 === m.version ? "" : null,
                            // https://cloudflareinsights.com/cdn-cgi/rum
                            P = function (r) {
                                var a = function (e, t) {
                                    c.resources = e,
                                    0 != t && (c.bypassTiming = !0),
                                    m && (1 === m.r && (c.resources = []), (0, o.sendObjectBeacon)("", c, (function () {}), !1, C), void 0 !== m.forward && void 0 !== m.forward.url && (0, o.sendObjectBeacon)("", c, (function () {}), !1, m.forward.url))
                                },
                                c = function (r) {
                                    var o,
                                    a,
                                    ...
                                    return JSON.stringify(g).length >= 64e3 && (g.resources = []),
                                ...
                                if (c && m) {
                                    ...
                                    if (delete c.tempResources, L && s && 0 === s.length && a([], 0), !s)
                                        return;
                            ...
                            R = function () {
                                var t = function () {
                                    ...
                                    return m && (m.version && (r.versions.fl = m.version), m.icTag && (r.icTag = m.icTag), N(r, m.abtestTags), r.siteToken = m.token),
                                    b && ["lcp", "fid", "cls", "fcp", "ttfb", "inp"].forEach((function (e) {
                                            r[e] = {
                                                value: -1,
                                                path: void 0
                                            },
                                ...
                                m && (0, o.sendObjectBeacon)("", t, (function () {}), !0, C)
                            },
                            B = function () {
                            ...
                            L && (s = e(), function (t) {
                                ...
                                if (n) {
                                    var r = function () {
                                        v = c(),
                                        "function" == typeof f.clearResourceTimings && f.clearResourceTimings()
                                    };
                                    t.pushState = function (i, o, a) {
                                        ...
                                        s = !0;
                                        return u == c && (s = !1),
                                        s && (A() && ((null == S ? void 0 : S.url) == c && (null == S ? void 0 : S.triggered) || P(c), O(c)), r()),
                                        n.apply(t, [i, o, a])
                                    },
                                    window.addEventListener("popstate", (function (t) {
                                            A() && ((null == S ? void 0 : S.url) == u && (null == S ? void 0 : S.triggered) || P(u), O(u)),
                                            u = e(),
                                            r()
                                        }))
                                }
                    ...
                    function k(e) {
                        if ("function" == typeof f.getEntriesByType) {
                            ...
                            r = {};
                            e.timingsV2 = {},
                            t && t[0] && t[0].nextHopProtocol && (r.nextHopProtocol = t[0].nextHopProtocol),
                            n(r, e.timingsV2)
                        }
                    }
                    function M(e) {
                    ...
                    !function (e, t) {
                        ...
                        P((function () {
                                ...
                                o = function (e) {
                                    e.forEach((function (e) {
                                            e.interactionId && z(e),
                                            "first-input" === e.entryType && !J.some((function (t) {
                                    ...
                                    var t,
                                    n = (t = Math.min(J.length - 1, Math.floor(H() / 50)), J[t]);
                                ...
                                a && (a.observe({
                                        ...
                                        buffered: !0
                                            ...
                                            o(a.takeRecords()),
                                            i.value < 0 && H() > 0 && (i.value = 0, i.entries = []),
                                            r(!0)
                                        })), l((function () {
                                            J = [],
                                            q = V(),
